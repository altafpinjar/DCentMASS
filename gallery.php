...
<div class="container gallery-container">
    ...
    <div class="tz-gallery">    
        <div class="row">
            ...
            <div class="col-sm-6 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/bridge.jpg">
                    <img src="../../DCentMass/images/maktum/bridge.jpg" alt="Bridge">
                </a>
            </div>
            <div class="col-sm-12 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/tunnel.jpg">
                    <img src="../../DCentMass/images/maktum/tunnel.jpg" alt="Tunnel">
                </a>
            </div>
            <div class="col-sm-6 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/coast.jpg">
                    <img src="../../DCentMass/images/maktum/coast.jpg" alt="Coast">
                </a>
            </div>
            <div class="col-sm-6 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/rails.jpg">
                    <img src="../../DCentMass/images/maktum/rails.jpg" alt="Rails">
                </a>
            </div>
            <div class="col-sm-6 col-md-2">
         ...
         <div class="row">
            <div class="col-sm-6 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/sky.jpg">
                    <img src="../../DCentMass/images/maktum/sky.jpg" alt="Park">
                </a>
            </div>
            <div class="col-sm-6 col-md-2">
                <a class="lightbox" href="../../DCentMass/images/maktum/bridge.jpg">
